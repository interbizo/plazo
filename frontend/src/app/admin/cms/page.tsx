...
import { CmsBannersManager } from "@/components/admin/cms/cms-banners-manager";
import { CmsFaqsManager } from "@/components/admin/cms/cms-faqs-manager";
import { LandingBenefitsManager } from "@/components/admin/cms/landing-benefits-manager";
import { LandingStepsManager } from "@/components/admin/cms/landing-steps-manager";
import { LandingAdvantagesManager } from "@/components/admin/cms/landing-advantages-manager";
import { LandingTestimonialsManager } from "@/components/admin/cms/landing-testimonials-manager";
import { LandingHeroManager } from "@/components/admin/cms/landing-hero-manager";
...
type Tab = "hero" | "benefits" | "steps" | "advantages" | "testimonials" | "pages" | "banners" | "faqs" | "settings" | "flash-sale";
...
export default function AdminCmsPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-wrap gap-2 border-b border-gray-200 pb-3">
        {(
          [
            ...
            { key: "benefits", label: "Benefit", icon: Sparkles },
            { key: "steps", label: "Cara Kerja", icon: Zap },
            { key: "advantages", label: "Keunggulan", icon: Check },
      ...
      {tab === "hero" && <LandingHeroManager />}
      {tab === "benefits" && <LandingBenefitsManager />}
      {tab === "steps" && <LandingStepsManager />}
      {tab === "advantages" && <LandingAdvantagesManager />}
      {tab === "testimonials" && <LandingTestimonialsManager />}
      {tab === "pages" && <CmsPages />}
      {tab === "banners" && <CmsBannersManager />}
      {tab === "faqs" && <CmsFaqsManager />}
